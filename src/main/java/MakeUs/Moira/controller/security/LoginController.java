...
public class LoginController {
    ...
    public SingleResult<String> getToken(@ApiParam(value = "AccessToken", required = true) @RequestParam String accessToken, //
                                         @ApiParam(value = "kakao or apple", required = true) @RequestParam String providerName) {
        /*
        1. AccessToken을 꺼냄
