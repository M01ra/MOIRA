...
public class ProjectCommentController {
    ...
    public SingleResult<Long> createProjectComment(@RequestBody ProjectCommentRequestDTO projectCommentRequestDTO, @ApiParam(value = "프로젝트(팀) ID", required = true) @PathVariable Long projectId, @ApiParam(value = "부모 댓글 ID") @RequestParam(name = "parent", required = false) Long parentId, @RequestHeader(value = "X-AUTH-TOKEN") String token){
    ...
    public ListResult<ProjectCommentResponseDTO> getProjectComments(@ApiParam(value = "프로젝트(팀) ID", required = true) @PathVariable Long projectId, @RequestHeader(value = "X-AUTH-TOKEN") String token){
    ...
    public CommonResult deleteProjectComment(@ApiParam(value = "댓글 ID", required = true) @PathVariable Long commentId, @RequestHeader(value = "X-AUTH-TOKEN") String token){
